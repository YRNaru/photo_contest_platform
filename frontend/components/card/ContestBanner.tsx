  ...
  return (
    <div className="h-40 sm:h-48 lg:h-56 bg-gradient-to-br from-purple-500 via-pink-500 to-purple-600 dark:from-purple-600 dark:via-pink-600 dark:to-purple-700 flex items-center justify-center relative overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-64 h-64 bg-pink-300 rounded-full blur-3xl animate-pulse-slow"
          style={{ animationDelay: '1s' }}
        ></div>
      </div>
      <span className="text-white text-5xl sm:text-6xl lg:text-7xl relative z-10 group-hover:scale-110 transition-transform duration-300">
        📸
      </span>
    </div>
  )
