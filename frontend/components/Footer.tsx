  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 dark:bg-black text-gray-300 dark:text-gray-400 mt-auto overflow-hidden border-t dark:border-gray-800">
      ...
      <div className="absolute inset-0 opacity-10 dark:opacity-5">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-pink-500 dark:bg-pink-600 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 animate-fadeInUp">
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: '100ms' }}>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/contests" className="group flex items-center gap-2 hover:text-purple-400 dark:hover:text-purple-300 transition-all duration-300 hover:translate-x-2">
              ...
              <li>
                <Link href="/submit" className="group flex items-center gap-2 hover:text-purple-400 dark:hover:text-purple-300 transition-all duration-300 hover:translate-x-2">
                  <span className="w-1.5 h-1.5 bg-purple-400 dark:bg-purple-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  写真を投稿
                </Link>
              </li>
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: '200ms' }}>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/guidelines" className="group flex items-center gap-2 hover:text-pink-400 dark:hover:text-pink-300 transition-all duration-300 hover:translate-x-2">
                  <span className="w-1.5 h-1.5 bg-pink-400 dark:bg-pink-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  ガイドライン
                </Link>
              </li>
              <li>
                <Link href="/faq" className="group flex items-center gap-2 hover:text-pink-400 dark:hover:text-pink-300 transition-all duration-300 hover:translate-x-2">
                  <span className="w-1.5 h-1.5 bg-pink-400 dark:bg-pink-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  よくある質問
                </Link>
              </li>
              <li>
                <Link href="/contact" className="group flex items-center gap-2 hover:text-pink-400 dark:hover:text-pink-300 transition-all duration-300 hover:translate-x-2">
                  <span className="w-1.5 h-1.5 bg-pink-400 dark:bg-pink-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  お問い合わせ
                </Link>
              </li>
          ...
          <div className="animate-fadeInRight">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/terms" className="group flex items-center gap-2 hover:text-blue-400 dark:hover:text-blue-300 transition-all duration-300 hover:translate-x-2">
              ...
              <li>
                <Link href="/privacy" className="group flex items-center gap-2 hover:text-blue-400 dark:hover:text-blue-300 transition-all duration-300 hover:translate-x-2">
                  <span className="w-1.5 h-1.5 bg-blue-400 dark:bg-blue-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  プライバシーポリシー
                </Link>
              </li>
              <li>
                <Link href="/cookie-policy" className="group flex items-center gap-2 hover:text-blue-400 dark:hover:text-blue-300 transition-all duration-300 hover:translate-x-2">
                  <span className="w-1.5 h-1.5 bg-blue-400 dark:bg-blue-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Cookieポリシー
                </Link>
              </li>
        ...
        {/* コピーライト */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6 animate-fadeInUp text-center md:text-left" style={{ animationDelay: '300ms' }}>
          ...
          <div className="flex gap-4 sm:gap-6">
            ...
            >
              <svg className="w-6 h-6 group-hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.8)]" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <svg className="w-6 h-6 group-hover:drop-shadow-[0_0_8px_rgba(236,72,153,0.8)]" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <svg className="w-6 h-6 group-hover:drop-shadow-[0_0_8px_rgba(96,165,250,0.8)]" fill="currentColor" viewBox="0 0 24 24">
