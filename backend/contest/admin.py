...
class ContestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("審査設定", {"fields": ("judging_type", "max_votes_per_judge")}),
        ("期間設定", {"fields": ("start_at", "end_at", "voting_end_at")}),
        (
            "応募設定",
            {
                "fields": (
...
class EntryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("ステータス", {"fields": ("approved", "flagged", "flag_reason", "view_count")}),
        (
            "Twitter情報",
            {
                "fields": (
...
class CategoryAdmin(admin.ModelAdmin):
    list_display = ("name", "contest", "order", "max_votes_per_judge", "created_at")
...
class JudgingCriteriaAdmin(admin.ModelAdmin):
    list_display = ("name", "contest", "category", "max_score", "order", "created_at")
...
class DetailedScoreAdmin(admin.ModelAdmin):
    list_display = ("judge_score", "criteria", "score", "created_at")
