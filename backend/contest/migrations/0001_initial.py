    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "voting_end_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="投票終了日時"),
                ),
                ("is_public", models.BooleanField(default=True, verbose_name="公開")),
                (
                    "max_entries_per_user",
                    models.IntegerField(default=1, verbose_name="ユーザーあたり最大応募数"),
                ),
                (
                    "max_images_per_entry",
                    models.IntegerField(default=5, verbose_name="エントリーあたり最大画像数"),
                ),
                (
                    "twitter_hashtag",
                    models.CharField(
                ...
                (
                    "twitter_auto_fetch",
                    models.BooleanField(default=False, verbose_name="Twitter自動取得"),
                ),
                (
                    "twitter_auto_approve",
                    models.BooleanField(default=False, verbose_name="Twitter投稿の自動承認"),
                ),
                (
                    "twitter_last_fetch",
                    models.DateTimeField(blank=True, null=True, verbose_name="最終取得日時"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        choices=[("manual", "手動投稿"), ("twitter", "Twitter自動取得")],
                        default="manual",
                        max_length=20,
                        verbose_name="投稿元",
                    ),
                ...
                (
                    "twitter_url",
                    models.URLField(blank=True, null=True, verbose_name="ツイートURL"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(upload_to="entries/%Y/%m/%d/", verbose_name="画像"),
                ),
                (
                    "thumbnail",
                    models.ImageField(
                ...
                (
                    "is_thumbnail_ready",
                    models.BooleanField(default=False, verbose_name="サムネイル生成済み"),
                ),
