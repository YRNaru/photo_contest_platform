...
from rest_framework.decorators import (
    action, api_view, permission_classes as perm_classes
)
...
class UserViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def set_twitter_icon(self, request):
        ...
        # プロフィール画像URLを取得
        profile_image_url = (
            twitter_account.extra_data.get('profile_image_url')
        )
        ...
        try:
            ...
            # ファイル名を生成
            file_ext = (
                os.path.splitext(profile_image_url)[1] or '.jpg'
            )
